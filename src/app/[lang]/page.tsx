...
import { getDictionary, isLang, localePath } from "@/lib/i18n";
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:py-12">
      ...
      <section className="space-y-5">
        ...
        <div className="flex flex-wrap gap-3 pt-1">
          ...
          <Button
            size="lg"
            variant="outline"
            render={<Link href={localePath(lang, "/recursos")} />}
            className="gap-2"
          >
      ...
      <section className="mt-12 space-y-4">
        <header className="flex flex-wrap items-end justify-between gap-2">
          ...
          <Link
            href={localePath(lang, "/servicios")}
      ...
      <section className="mt-12 rounded-xl border bg-muted/40 p-6 sm:p-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button
            ...
            render={<Link href={localePath(lang, "/organizaciones")} />}
          >
