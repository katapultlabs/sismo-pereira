...
const es = {
  meta: {
    title: "AquíAyuda — Información verificada en tiempo real",
    description:
  ...
  status: {
    ...
    /* Accessible names for the carousel's prev/next pair below `lg`. The
       buttons showed "← / →" as their label, which a screen reader announces
       as the glyph, not the action. */
...
const en: typeof es = {
  meta: {
    title: "AquíAyuda — Verified real-time earthquake information",
    description:
